...
| `showHidden`          | <code>"none" &#124; "always" &#124; "exclude-meta"</code>  | `"none"`                           | Whether to show hidden (non-enumerable) properties. If set to `"exclude-meta"`, it behaves like `"always"` but removes common meta properties like the `length` property of arrays.                                                                                                              |
| `getters`             | <code>"none" &#124; "get" &#124; "set" &#124; "all"</code> | `"none"`                           | Whether to inspect getters. If set to `"get"`, only getters without a corresponding setter are inspected. If set to `"set"`, only getters with a corresponding setter are inspected. If set to `"all"`, all getters are inspected.                                                               |
