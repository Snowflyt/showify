...
- **Long arrays, `Map`s, and `Set`s:** If `maxArrayLength` is set and one of these collections has more elements than `maxArrayLength`, it is truncated and displays the omitted count, e.g., `[1, 2, 3, 4, ... 2 more items]`, `Map(3) { "a" => 1, ... 2 more items }`, or `Set(3) { "a", ... 2 more items }`.
...
| `maxArrayLength`      | `number`                                                                  | `Infinity`                         | Maximum number of elements to display for arrays, `Map`s, and `Set`s. If one of these collections has more elements than `maxArrayLength`, the output is truncated and includes the omitted count.                                                                                                                                                                                                                                     |
