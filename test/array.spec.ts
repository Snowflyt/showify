...
describe("Array", () => {
  ...
  it("should show arrays with empty slots", () => {
    ...
    expect(inspect([1, , ,], { colors: true })).toEqual(util.inspect([1, , ,], { colors: true }));
    // Only empty slots
    expect(show([, , ,])).toEqual("[<3 empty items>]");
    expect(inspect([, , ,])).toEqual(util.inspect([, , ,]));
    expect(inspect([, , ,], { colors: true })).toEqual(util.inspect([, , ,], { colors: true }));
  });
  ...
  it("should truncate long arrays if `maxArrayLength` is set", () => {
    ...
    expect(inspect([1, 2, 3, 4], { maxArrayLength: 4, colors: true })).toEqual(
      util.inspect([1, 2, 3, 4], { maxArrayLength: 4, colors: true }),
    );
    ...
    expect(inspect([1, 2, 3, 4, 5], { maxArrayLength: 4, colors: true })).toEqual(
      util.inspect([1, 2, 3, 4, 5], { maxArrayLength: 4, colors: true }),
    );
    expect(
  ...
  it("should not group elements for short arrays", () => {
    ...
    expect(inspect(arr)).toEqual(util.inspect(arr));
    expect(inspect(arr, { colors: true })).toEqual(util.inspect(arr, { colors: true }));

    expect(show(arr, { indent: 2, maxArrayLength: 4 })).toEqual("[1, 2, 3, 4, ... 2 more items]");
    expect(inspect(arr, { maxArrayLength: 4 })).toEqual(util.inspect(arr, { maxArrayLength: 4 }));
    expect(inspect(arr, { maxArrayLength: 4, colors: true })).toEqual(
      util.inspect(arr, { maxArrayLength: 4, colors: true }),
    );
    ...
    expect(inspect(arr, { maxArrayLength: 5, colors: true })).toEqual(
      util.inspect(arr, { maxArrayLength: 5, colors: true }),
    );
  });
  ...
  it("should not group elements if huge gaps may occur", () => {
    ...
    expect(inspect(arr, { breakLength: 30, colors: true })).toEqual(
      util.inspect(arr, { breakLength: 30, colors: true }),
    );
    ...
    expect(inspect(arr, { breakLength: 30, maxArrayLength: 8, colors: true })).toEqual(
      util.inspect(arr, { breakLength: 30, maxArrayLength: 8, colors: true }),
    );
  });
  ...
  it("should group elements for arrays with many short elements", () => {
    ...
    expect(inspect(arr, { maxArrayLength: 60, colors: true })).toEqual(
      util.inspect(arr, { maxArrayLength: 60, colors: true }),
    );
    ...
    expect(inspect(arr, { maxArrayLength: 90, colors: true })).toEqual(
      util.inspect(arr, { maxArrayLength: 90, colors: true }),
    );
  });
});
